...
def line_fit(binary_warped):
	...
	for window in range(nwindows):
		...
		out_img = cv2.rectangle(out_img, tuple(left_start), tuple(left_end), (0,255,0), 2)
		out_img = cv2.rectangle(out_img, tuple(right_start), tuple(right_end), (0,0,255), 2)
		####
		# Identify the nonzero pixels in x and y within the window
		##TO DO
		left_inds1 = (nonzerox < win_xleft_high) & (nonzerox > win_xleft_low) & (nonzeroy < winyhigh) & (nonzeroy > winylow)
		right_inds1 = (nonzerox < win_xright_high) & (nonzerox > win_xright_low) & (nonzeroy < winyhigh) & (nonzeroy > winylow)
